	...
	first: {afficherChoixAdherent(); }
		...
		case 1:
			...
			case 1:
				...
				cout << "___________________Tapez le nombre de jour de la formation :" << endl;
				cout << "   " << endl;
				cin >> nombreJour;
			...
			case 2:
				...
				case 1:
					...
					cout << "___________________nv_nomF" << endl;
					cout << "   " << endl;
					cin >> nv_nomF;
			...
			case 3:
				...
				cout << "Reservation suprimee" << endl;
				break;
			case 4:
				goto first;
				break;
